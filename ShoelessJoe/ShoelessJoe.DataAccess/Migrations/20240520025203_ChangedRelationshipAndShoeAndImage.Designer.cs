...
namespace ShoelessJoe.DataAccess.Migrations
{
    ...
    [Migration("20240520025203_ChangedRelationshipAndShoeAndImage")]
    partial class ChangedRelationshipAndShoeAndImage
    {
            ...
            modelBuilder.Entity("ShoelessJoe.DataAccess.DataModels.Shoe", b =>
                {
                    ...
                    b.HasOne("ShoelessJoe.DataAccess.DataModels.ShoeImage", "ShoeImage")
                        .WithOne("Shoe")
                        .HasForeignKey("ShoelessJoe.DataAccess.DataModels.Shoe", "ShoeImageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
